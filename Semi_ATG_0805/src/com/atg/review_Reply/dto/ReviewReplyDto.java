package com.atg.review_Reply.dto;
...
public class ReviewReplyDto {
	...
	/* 인서트 부분 */
	 public ReviewReplyDto (int rv_no ,String mb_id, String rr_content) {
		this.rv_no=rv_no;
		this.mb_id = mb_id; 
	...
	public ReviewReplyDto(int rv_no,String mb_id, String rr_content, int rr_groupseq) {
		this.rr_no=rr_no;
		this.mb_id=mb_id;
		this.rr_content = rr_content;
	...
	public ReviewReplyDto (int rr_no, int rv_no, int rr_groupseq, int rr_tab, String id, String rr_content,
			Date rr_date) {
		this.rr_no = rr_no;
		this.rv_no = rv_no;
		this.rr_groupseq = rr_groupseq;
