...
%>
	...
	<section class="secssion">
		...
		<div id="banner_box">
			<ul>
				<li><img src="resources/img/banner1.png"
					onclick="location.href=''" /></li>
				<li><img src="resources/img/banner2.png"
					onclick="location.href=''" /></li>
				<li><img src="resources/img/banner3.png"
					onclick="location.href=''" /></li>
				<li><img src="resources/img/banner4.png"
					onclick="location.href=''" /></li>
				<li><img src="resources/img/banner5.png"
					onclick="location.href=''" /></li>
			</ul>
		...
		<div id="ranking_box">
			<div id="ranking_a">
				<div class="ranking_content">
					<ul>
						<li onclick="location.href=''"><div class="divbox">Best
								ProG</div> <br />Best 1<img src="resources/img/2.jpg" /></li>
						<li onclick="location.href=''"><div class="divbox">Best
								ProG</div> <br />Best 2<img src="resources/img/3.jpg" /></li>
						<li onclick="location.href=''"><div class="divbox">Best
								ProG</div> <br />Best 3<img src="resources/img/4.jpg" /></li>
					</ul>
				</div>
			</div>
			...
			<div id="ranking_b">
				<div class="ranking_content">
					<ul>
						<li onclick="location.href=''"><div class="divbox">Best
								Item</div> <br />Best 1<img src="resources/img/5.jpg" /></li>
						<li onclick="location.href=''"><div class="divbox">Best
								Item</div> <br />Best 2<img src="resources/img/6.jpg" /></li>
						<li onclick="location.href=''"><div class="divbox">Best
								Item</div> <br />Best 3<img src="resources/img/2.jpg" /></li>
					</ul>
				</div>
			</div>
		</div>
